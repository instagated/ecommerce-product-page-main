...
const Index = () => {
	...
	return (
		<header className='w-full xl:w-[1110px] flex justify-between items-center gap-5 xl:gap-0 md:py-9 border-b border-grayish-blue md:px-0 px-8 py-8'>
			<div className="flex items-center md:items-stretch gap-5 md:gap-10">
				...
				<ul className='hidden md:flex gap-8 text-dark-grayish-blue'>
					{
						menu.map((item, index) => (
			...
			<div className="flex gap-6 lg:gap-10 items-center relative">
